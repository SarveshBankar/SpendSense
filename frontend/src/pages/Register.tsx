...
import { User, Mail, Lock, Eye, EyeOff, LayoutDashboard, ArrowRight, Zap, Globe, Clock } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-surface flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-16">
        ...
        <div className="blob w-[500px] h-[500px] bg-accent-500/15 top-[-15%] right-[-10%] animate-blob-reverse" />
        <div className="blob w-[400px] h-[400px] bg-primary-500/12 bottom-[-10%] left-[-5%] animate-blob" />
        ...
        >
          ...
          <h1 className="hero-title text-gradient mb-4">Get Started</h1>
        ...
        >
          <div className="mb-10">
            <div className="lg:hidden flex items-center gap-2.5 mb-8">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-accent-500 to-accent-600 flex items-center justify-center shadow-glow-accent">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" required value={name} onChange={(e) => setName(e.target.value)} placeholder="John Doe" className="input-premium !pl-11" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPw ? 'text' : 'password'} required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Min. 8 characters" className="input-premium !pl-11 !pr-11" />
